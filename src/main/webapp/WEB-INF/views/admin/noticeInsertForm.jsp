...
<article style="min-height:500px;margin-top:100px;">
	...
	<div class="qnaWriteBox" style="border: 1px solid black; margin: 0 auto;
			width: 750px;">
		<form id="noticeInsert" action="noticeInsert" method="post" name="noticeInsertform">
			<table border="1px solid red;">
				<tr>
					...
					<td style="width: 550px; text-align: center;">
						<input type="text" style="width: 97%;" value="${bvo.ntitle }"
							name="ntitle">
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="2" style="text-align: center;">
						...
						<input type="button" class="QnaButton" value="돌아가기" onclick="location.href='noticeManageList'"
							style="cursor: pointer;">
					</td>
				</tr>
			</table>
