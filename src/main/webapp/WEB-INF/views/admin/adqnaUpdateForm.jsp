...
<article style="min-height:500px;margin-top:100px;">
	<h1 style="text-align: center">자주 묻는 질문 수정</h1>
	<div class="qnaWriteBox" style="border: 1px solid black; margin: 0 auto;
			width: 750px;">
		<form action="adqnaUpdate" method="post" name="adqnaUpdate">
			<input type="hidden" value="${bvoList.adqseq }" name="adqseq"/>
			<table>
				<tr>
				...
				<tr>
					<td colspan="2" style="text-align: center;">
						...
						<input type="button" class="QnaButton" value="돌아가기" onclick="location.href='adqnaManageList?first=yes'"
							style="cursor: pointer;">
					</td>
				</tr>
			</table>
